...
function creerCafe(cafe,petitGateau){
    function service(nbrClient){
        if (cafe<nbrClient || petitGateau<nbrClient){
            return "désolé"
        }
        cafe=cafe-nbrClient
        petitGateau=petitGateau-nbrClient
        return "Nous avons servi "+nbrClient+ "clients et il reste"+cafe +" cafés et" +petitGateau+ "petits gâteaux"
    }
    return service
}
let cofee =creerCafe(20,15)
